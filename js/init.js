const CATEGORIES_URL = "http://localhost:5000/api/data/cat/cat";
const PUBLISH_PRODUCT_URL = "http://localhost:5000/api/data/sell/publish";
const PRODUCTS_URL = "http://localhost:5000/api/data/cats_products";
const PRODUCT_INFO_URL = "http://localhost:5000/api/data/products";
const PRODUCT_INFO_COMMENTS_URL = "http://localhost:5000/api/data/products_comments";
const CART_INFO_URL = "http://localhost:5000/api/data/user_cart";
const CART_BUY_URL = "http://localhost:5000/api/data/cart/buy";
const EXT_TYPE = ".json";
